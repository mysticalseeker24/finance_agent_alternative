...
class RetrieverAgent(BaseAgent):
    ...
    async def _index_texts(self, texts: List[str], metadata_list: Optional[List[Dict[str, Any]]] = None, namespace: str = "default") -> Dict[str, Any]:
    ...
    async def _search(self, query: str, namespace: str = "default", top_k: int = 5) -> List[Dict[str, Any]]:
    ...
    async def _delete(self, ids: List[str] = None, namespace: str = "default", delete_all: bool = False) -> bool:
    ...
    async def index_content(self, texts: List[str], metadata_list: Optional[List[Dict[str, Any]]] = None, namespace: str = "default") -> Dict[str, Any]:
    ...
    async def search_content(self, query: str, namespace: str = "default", top_k: int = 5) -> Dict[str, Any]:
    ...
    async def delete_content(self, ids: List[str] = None, namespace: str = "default", delete_all: bool = False) -> Dict[str, Any]:
