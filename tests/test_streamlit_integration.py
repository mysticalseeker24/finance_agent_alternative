    ...
    def test_market_summary_api_integration(self, mock_get):
        ...
        mock_response.json.return_value = {
            "data": {
                ...
                "^IXIC": {"name": "NASDAQ Composite", "price": 16789.54, "change_percent": 0.47}
            },
            "agent": "API Agent",
    ...
    def test_query_processing_api_integration(self, mock_post):
        ...
        mock_response.json.return_value = {
            "data": {
                ...
                "sources": [{"type": "market_data", "description": "Current stock price"}],
                "audio_url": None
            },
            "agent": "Orchestrator",
        ...
        # Verify the data was processed correctly
        self.assertEqual(result["response"], "Apple Inc. (AAPL) is currently trading at $180.95, up 0.69% today.")
